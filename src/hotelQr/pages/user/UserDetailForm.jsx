...
import { useCreateBookingMutation } from '../../redux/hotelUserApi.jsx/BookingAPI';
...
const UserDetailForm = () => {
  ...
  useEffect(() => {
    ...
    if (step === 4 && timer > 0) {
      ...
      navigate(`/hotelqr/NumberOfUsers/${hotel_id}`);
    }
  }, [step, timer]);
  ...
  />
                        ...
                        <label className="block text-gray-700 text-sm ml-6 mt-2">User Photo</label>
                        <div 
                          style={{ backgroundImage: `url(${aadhar})` }}
                         className="w-full h-64 bg-cover  px-4">
                   
                          <div className="relative w-full h-[145px] flex items-center justify-center">
                          {values.people[personIndex].date_of_birth && (
                             <p className=" absolute top-20 left-27 bg-gray-50 p-3">{` B.O.D : ${values.people[personIndex].date_of_birth} `}</p>    )}
                            {values.people[personIndex].aadhar_image && (
                              <img
                                ...
                                className=" absolute top-20 -left-2 mt w-24 h-30 mx-auto rounded-lg"
                              />
                            )}
