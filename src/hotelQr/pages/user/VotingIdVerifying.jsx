...
const VotingIdVerifying = () => {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col items-center min-h-screen pt-10 px-4"
    >
      ...
      >
        <button
          onClick={() => navigate("/hotelqr/VotingIdUserDetail", { state: { verifiedData, hotel, initialNumberOfPeople } })}
