...
// import { useDeletePassportMutation } from '../../../redux/adminApi/VoterDrivingPassApi';
import GovtSidebar from '../../Components/GovtSidebar';
import SearchLogout from '../../Components/SearchLogout';
import { useDeletePassportMutation } from '../../../admin/redux/adminApi/VoterDrivingPassApi';
import { useSelector } from 'react-redux';
// import { useDeletePassportMutation } from '../../redux/VoterDrivingPassApi';

const UserDetailsPassport = () => {
  ...
  const handleEdit = (id) => {
    navigate("/EditPassportUser", { state: userData });
  };
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col items-center w-full md:w-3/4 mx-8">
        ...
        <div className="bg-[#ECF8F9] w-full h-full rounded-3xl p-4 mt-2 flex justify-center">
          <div className="w-full max-w-3xl bg-white rounded-3xl shadow-md p-4 border border-[#0060EC]">
            ...
            <div className="flex flex-col items-center">
              ...
              <h2 className="mt-2 text-xl text-center">{userData.first_name} {userData.last_name}</h2>
              <p className="text-gray-500 text-center">{hotelNameToShow} </p>
            </div>

            {/* Profile Info */}
            <div className="flex justify-center px-24 w-full mt-6">
              <table className="w-3/4 text-left border-collapse">
                <tbody>
                  <tr>
                    <td className="text-gray-500">Passport No:</td>
                    <td className="pl-16">{userData.file_number }</td>
                  </tr>
                  <tr>
                    <td className="text-gray-500">File Number:</td>
                    <td className="pl-16">{userData.document_id}</td>
                  </tr>
                  <tr>
                    <td className="text-gray-500">Phone Number:</td>
                    <td className="pl-16">{userData.phone_number}</td>
                  </tr>
                  {/* <tr>
                  ...
                  <tr>
                    <td className="text-gray-500">Room No:</td>
                    <td className="pl-16">{userData.room_number}</td>
                  </tr>
                  <tr>
...
export default UserDetailsPassport;
